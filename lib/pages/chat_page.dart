...
class ChatPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var email = ModalRoute.of(context)?.settings.arguments as String? ?? 'guest@example.com';
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasData) {
          List<Message> messagesList = snapshot.data!.docs.map((doc) => Message.fromJson(doc)).toList();
